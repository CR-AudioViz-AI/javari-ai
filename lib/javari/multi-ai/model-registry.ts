...
const STATIC_MODELS: ModelDefinition[] = [
  { id:"groq:llama-3.3-70b-versatile", provider:"groq", model_id:"llama-3.3-70b-versatile", display_name:"Llama 3.3 70B (Groq)", capabilities:{reasoning:3,json_reliability:3,code_quality:3,multimodal:false,streaming:true,tools:false}, cost_per_1k_tokens:0, latency_class:"fast", max_tokens:8192, context_window:131072, active:true, registry_version:STATIC_REGISTRY_VERSION },
  { id:"groq:llama-3.1-8b-instant", provider:"groq", model_id:"llama-3.1-8b-instant", display_name:"Llama 3.1 8B (Groq)", capabilities:{reasoning:2,json_reliability:2,code_quality:2,multimodal:false,streaming:true,tools:false}, cost_per_1k_tokens:0, latency_class:"fast", max_tokens:8192, context_window:131072, active:true, registry_version:STATIC_REGISTRY_VERSION },
  { id:"openai:gpt-4o-mini", provider:"openai", model_id:"gpt-4o-mini", display_name:"GPT-4o Mini", capabilities:{reasoning:3,json_reliability:4,code_quality:3,multimodal:true,streaming:true,tools:true}, cost_per_1k_tokens:0.0015, latency_class:"medium", max_tokens:16384, context_window:128000, active:true, registry_version:STATIC_REGISTRY_VERSION },
  { id:"openai:o4-mini", provider:"openai", model_id:"o4-mini", display_name:"o4-mini", capabilities:{reasoning:5,json_reliability:4,code_quality:5,multimodal:false,streaming:true,tools:true}, cost_per_1k_tokens:0.011, latency_class:"slow", max_tokens:65536, context_window:200000, active:true, registry_version:STATIC_REGISTRY_VERSION },
  { id:"openai:o3", provider:"openai", model_id:"o3", display_name:"o3", capabilities:{reasoning:5,json_reliability:4,code_quality:5,multimodal:false,streaming:false,tools:true}, cost_per_1k_tokens:0.10, latency_class:"slow", max_tokens:100000, context_window:200000, active:true, registry_version:STATIC_REGISTRY_VERSION },
  { id:"anthropic:claude-sonnet-4-20250514", provider:"anthropic", model_id:"claude-sonnet-4-20250514", display_name:"Claude Sonnet 4", capabilities:{reasoning:5,json_reliability:4,code_quality:5,multimodal:true,streaming:true,tools:true}, cost_per_1k_tokens:0.009, latency_class:"medium", max_tokens:8192, context_window:200000, active:true, registry_version:STATIC_REGISTRY_VERSION },
  { id:"mistral:mistral-small-latest", provider:"mistral", model_id:"mistral-small-latest", display_name:"Mistral Small", capabilities:{reasoning:3,json_reliability:5,code_quality:3,multimodal:false,streaming:true,tools:true}, cost_per_1k_tokens:0.001, latency_class:"medium", max_tokens:8192, context_window:32000, active:true, registry_version:STATIC_REGISTRY_VERSION },
  { id:"mistral:mistral-large-latest", provider:"mistral", model_id:"mistral-large-latest", display_name:"Mistral Large", capabilities:{reasoning:4,json_reliability:5,code_quality:4,multimodal:false,streaming:true,tools:true}, cost_per_1k_tokens:0.006, latency_class:"medium", max_tokens:8192, context_window:128000, active:true, registry_version:STATIC_REGISTRY_VERSION },
  { id:"openrouter:meta-llama/llama-3.3-70b-instruct", provider:"openrouter", model_id:"meta-llama/llama-3.3-70b-instruct", display_name:"Llama 3.3 70B (OpenRouter)", capabilities:{reasoning:3,json_reliability:3,code_quality:3,multimodal:false,streaming:true,tools:false}, cost_per_1k_tokens:0.0008, latency_class:"medium", max_tokens:8192, context_window:131072, active:true, registry_version:STATIC_REGISTRY_VERSION },
  { id:"xai:grok-2", provider:"xai", model_id:"grok-2", display_name:"Grok 2", capabilities:{reasoning:3,json_reliability:3,code_quality:3,multimodal:true,streaming:true,tools:true}, cost_per_1k_tokens:0.005, latency_class:"medium", max_tokens:8192, context_window:131072, active:true, registry_version:STATIC_REGISTRY_VERSION },
  { id:"perplexity:llama-3.1-sonar-large-128k-online", provider:"perplexity", model_id:"llama-3.1-sonar-large-128k-online", display_name:"Sonar Large (Perplexity)", capabilities:{reasoning:3,json_reliability:2,code_quality:2,multimodal:false,streaming:true,tools:false}, cost_per_1k_tokens:0.005, latency_class:"medium", max_tokens:4096, context_window:127072, active:true, registry_version:STATIC_REGISTRY_VERSION },
];
