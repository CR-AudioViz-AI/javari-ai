  ...
  try {
    ...
    const [
      ...
      sb
        ...
        .select("provider, model, tier, cost, latency_ms, success, error_type, created_at, user_id, routing_version, registry_version, routing_primary, routing_chain, routing_scores, routing_weights, capability_override")
