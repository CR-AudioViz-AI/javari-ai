...
export const metadata: Metadata = {
  ...
  description: 'Your AI partner for development, debugging, and deployment. Build smarter with Javari AI.',
  keywords: ['AI', 'Assistant', 'Development', 'Automation', 'Self-Healing'],
  authors: [{ name: 'CR AudioViz AI' }],
  openGraph: {
    title: 'Javari AI',
    description: 'Autonomous, Self-Healing AI Assistant for Developers',
    type: 'website',
    siteName: 'Javari AI',
  },
  icons: {
