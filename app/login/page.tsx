        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="flex justify-center mb-6">
            <Link href="/" className="flex items-center gap-2">
              ...
              />
              <span className="text-2xl font-bold text-white">Javari AI</span>
            </Link>
          </div>

          <h1 className="text-2xl font-bold text-center text-white mb-2">Welcome Back</h1>
          <p className="text-center text-gray-300 mb-6">Sign in to continue to Javari AI</p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <Link href="/forgot-password" className="text-purple-300 hover:text-purple-200 transition">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white hover:bg-white/20 transition"
              >
          ...
          <p className="mt-6 text-center text-gray-300 text-sm">
            ...
            <Link href="/signup" className="text-purple-300 hover:text-purple-200 font-medium transition">
              Sign up for free
            </Link>
          </p>
        </div>
