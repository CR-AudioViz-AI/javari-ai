...
> Generate harmonious brand color palettes from a seed color or description with hex codes, accessibility scores, and CSS/Tailwind export

**Family:** creative-suite
**Credits per use:** 2
**Minimum plan:** free
**Generated:** 2026-02-20T04:35:31.138Z
...
|-------|--------|-------------|
| `/tools/brand-color-palette` | GET | Module UI page |
| `/api/tools/brand-color-palette/process` | POST | Process request |
